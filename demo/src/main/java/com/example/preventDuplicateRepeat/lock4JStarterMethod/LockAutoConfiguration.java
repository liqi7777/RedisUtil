...
import com.example.preventDuplicateRepeat.lock4JStarterMethod.aop.LockAnnotationAdvisor;
import com.example.preventDuplicateRepeat.lock4JStarterMethod.aop.LockInterceptor;
...
public class LockAutoConfiguration {
    ...
    public LockExecutor lockExecutor(@Qualifier("stringRedisTemplate") RedisTemplate redisTemplate) {

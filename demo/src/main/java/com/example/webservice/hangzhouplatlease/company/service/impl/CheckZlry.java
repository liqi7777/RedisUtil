...
@XmlRootElement(name = "checkZlry")
public class CheckZlry {

    @XmlElementRef(name = "token", namespace = "http://impl.service.company.hzfc.com", type = JAXBElement.class, required = false)
    protected JAXBElement<String> token;
    @XmlElementRef(name = "keywords", namespace = "http://impl.service.company.hzfc.com", type = JAXBElement.class, required = false)
